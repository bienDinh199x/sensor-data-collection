...
(function() {
    ...
    function cb(m) {
        ...
        //         if (0 === m.renderCount || s || q) m._creditLink.setAttribute("href", ""), m._creditLink.innerHTML = "MTE";
    ...
    function ta(m, s) {
        ...
        q.setAttribute("id", "canvasjs-chart-canvas_tuong");
        Ga(q, m, s);
    ...
    var ba = 20,
        ...
        Sa = {
            colorSet: "colorSet1",
            backgroundColor: "transparent",//tuong_2018_11_16
            title: {
                fontFamily: Ea,
                fontSize: 32,
                fontColor: "white",//
    ...
    Ka.Chart = function() {
        ...
        function q(a, f) {
            ...
            if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
                ...
                // this._canvasJSContainer.style.display = "none";
        ...
        Z.prototype._initialize = function() {
            if (this.enabled) {
                ...
                var a;
                a = '<div style=" width: auto;height: auto;min-width: 0px';
                a += "line-height: auto;";
                ...
                a += "text-align: right;";
                a += "border: 0px solid #36404A;";
                a += v ? "background: transparent;" : "background: transparent;";
                a += "text-indent: 0px;";
