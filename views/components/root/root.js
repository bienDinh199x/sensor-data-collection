function renderRoot() {
  ...
  <div class="w3-bar w3-black">
    <div id="logo">
      <div id="logo_thanhnam"></div><span>THANH NAM TECH</span>
    </div>
  ...
  setTimeout(() => {
    ...
    gauge[0][0] = new Chart(document.getElementById('gauge0_0').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge0)));
    gauge[0][1] = new Chart(document.getElementById('gauge0_1').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge1)));
    gauge[0][2] = new Chart(document.getElementById('gauge0_2').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge2)));

    line[1] = new Chart(document.getElementById(`line_1`), JSON.parse(JSON.stringify(configChartLine)));
    gauge[1][0] = new Chart(document.getElementById('gauge1_0').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge0)));
    gauge[1][1] = new Chart(document.getElementById('gauge1_1').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge1)));
    gauge[1][2] = new Chart(document.getElementById('gauge1_2').getContext('2d'), JSON.parse(JSON.stringify(configChartGauge2)));
  }, 2000)
